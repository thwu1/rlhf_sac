...
class SACRLElement:
    ...
    plain_rewards: TensorType["response_size"]


@dataclass
class SACRLBatch:
    """
    A batched version of the SACRLElement. See SACRLElement for more details on individual fields.
    ...
    plain_rewards: TensorType["batch_size", "response_size"]
