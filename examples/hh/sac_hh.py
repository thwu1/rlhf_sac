...
default_config = TRLConfig(
    ...
    method=SACConfig(
        ...
        # chunk_size=16,
        chunk_size=4,
        sac_epochs=4,  # how many times updates on the same batch
        init_kl_coef=0.05,
        target=6,
        horizon=10000,
...
if config_name == "125M":
    ...
    default_config.train.checkpoint_dir = "checkpoints/sac_hh_1B"
    ...
    default_config.train.checkpoint_dir = "checkpoints/sac_hh_6B"
    ...
    default_config.train.checkpoint_dir = "checkpoints/sac_hh_20B"
    default_config.model.model_path = "EleutherAI/gpt-neox-20b"
    default_config.tokenizer.tokenizer_path = "EleutherAI/gpt-neox-20b"
    default_config.method.num_rollouts = 16
    default_config.method.chunk_size = 4
    default_config.method.sac_epochs = 2
